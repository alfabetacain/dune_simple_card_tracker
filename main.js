...
var $author$project$Main$viewGameMsg = F2(
	function (config, msg) {
...
var $author$project$Main$viewHistory = F2(
							...
							_List_fromArray(
								[
									...
									A2(
										...
										$author$project$Main$viewGameMsg(config),
										history))
								]))
						]))
				]));
			...
			[
				...
				_List_fromArray(
					[
						...
						A3($elm$html$Html$Lazy$lazy2, $author$project$Main$viewHistory, game.config, game.history)
					])),
				modal
			]));
};
